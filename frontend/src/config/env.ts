...
export const envConfig: EnvConfig = {
  ...
  NEXT_PUBLIC_BACKEND_API_URL: process.env.NEXT_PUBLIC_BACKEND_API_URL || process.env.BACKEND_API_URL || 'https://main.weam.ai/ai-chatbot-api',
  ...
  NEXT_PUBLIC_API_PREFIX: process.env.NEXT_PUBLIC_API_PREFIX || '/smart-bots',
